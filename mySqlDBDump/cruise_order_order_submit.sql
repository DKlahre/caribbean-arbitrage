...
--
-- Table structure for table `order_submit`
--

DROP TABLE IF EXISTS `order_submit`;
...
--
-- Dumping data for table `order_submit`
--

LOCK TABLES `order_submit` WRITE;
/*!40000 ALTER TABLE `order_submit` DISABLE KEYS */;
/*!40000 ALTER TABLE `order_submit` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-06-09 16:22:20
