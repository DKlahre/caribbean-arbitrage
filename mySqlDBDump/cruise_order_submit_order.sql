...
DROP TABLE IF EXISTS `submit_order`;
...
LOCK TABLES `submit_order` WRITE;
/*!40000 ALTER TABLE `submit_order` DISABLE KEYS */;
INSERT INTO `submit_order` VALUES (1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0.00);
/*!40000 ALTER TABLE `submit_order` ENABLE KEYS */;
UNLOCK TABLES;
