...
--
-- Table structure for table `provisioner5`
--

DROP TABLE IF EXISTS `provisioner5`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `provisioner5` (
